...
export const levels = [
    {name: "Easy", difficulty: 1, background: images.stacked_peaks_vertical, time: '1 min', hints: 3, freeHint: 1},
    {name: "Medium", difficulty: 2, background: images.stacked_waves_vertical, time: '40 s', hints: 2, freeHint: 0},
    {name: "Hard", difficulty: 3, background: images.layered_peaks_vertical, time: '30 s', hints: 1, freeHint: 0},
]
